                    ...
                    _ => {
                        for byte in v {
                            match byte {
                                ...
                                91 => cs = cs.fg(Color::LightRed),
                                92 => cs = cs.fg(Color::LightGreen),
                                93 => cs = cs.fg(Color::LightYellow),
                                94 => cs = cs.fg(Color::LightBlue),
                                95 => cs = cs.fg(Color::LightMagenta),
                                96 => cs = cs.fg(Color::LightCyan),
                                97 => cs = cs.fg(Color::White),
