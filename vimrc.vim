...
"
" Common in many programming languages, the next automates the task
" of moving a visually marked expression into a marker right next to
" an uninitialized variable, replacing the marked expression with
" the variable's name.
"
" To illustrate, suppose we have some mark 'a' right next to 'int i',
...
"
function! UseAssignedName(marker) range
